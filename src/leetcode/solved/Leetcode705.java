...
//
// 
//Follow up: Could you solve the problem without using the built-in HashSet libr
//ary? Related Topics 设计 哈希表 
// 👍 153 👎 0
...
public class Leetcode705 {
    public static void main(String[] args) {
        MyHashSet solution = new Leetcode705().new MyHashSet();
